...
from server_messages.WebServerMessages import WebServerMessages
from server_messages.Commandes import CommandMessagesHandler

logger = logging.getLogger(__name__)

LOGGING_NAMES = ['server_messages']
